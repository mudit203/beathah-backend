...
import { signInToken, tokenForVerify } from '../config/auth.js';
import { sendEmail } from '../lib/email-sender/sender.js';
import { customerRegisterBody } from '../lib/email-sender/templates/register/index.js';
import { forgetPasswordEmailBody } from '../lib/email-sender/templates/forget-password/index.js';
import { sendVerificationCode } from '../lib/phone-verification/sender.js';
